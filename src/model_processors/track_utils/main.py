...
from track_utils.dataloader import LoadVideo, LoadImages
...
def main(args):
    ...
    # initialize tracker
    tracker = JDETracker(args, frame_rate=frame_rate)
    timer = Timer()
    results = []
    
    print("Results will be saved at {}".format(save_dir))
    # img:  h w c; 1 3 608 1088
    # img0: c h w; 1080, 1920, 3
    for frame_id, (count, img, img0) in enumerate(dataloader):
...
if __name__ == '__main__':
    ...
    args.inp_shape = [608, 1088]
    args.img0_shape = [1080, 1920]
