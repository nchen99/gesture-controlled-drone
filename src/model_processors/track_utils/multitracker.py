...
import track_utils.matching as matching
...
class JDETracker(object):
    ...
    def __init__(self, opt, frame_rate=30):
        ...
        width = self.opt.img0_shape[1]
        height = self.opt.img0_shape[0]
        inp_width = self.opt.inp_shape[1]
        inp_height = self.opt.inp_shape[0]
    ...
    def update(self, outputs):
        ...
        dets = self.post_process(dets, self.meta)
